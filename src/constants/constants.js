// Personal Info
export const PAGE_TITLE = "Jennifer Miller";
export const NAME = {
  first: 'Jennifer',
  last: 'Miller',
  nickname: 'Jen'
...
export const WORK_LINK = (
  <a href={WORK_URL} rel="noopener noreferrer" target="_blank" >
    Benefitfocus
  </a>
);
export const JOSH_ALLEN_LINK = (
  <a href={JOSH_ALLEN_URL} rel="noopener noreferrer" target="_blank" >
    Josh Allen
  </a>
);
export const TRAIL_LINK = (
  <a href={TRAIL_URL} rel="noopener noreferrer" target="_blank" >
    Swamp Rabbit Trail
  </a>
);
